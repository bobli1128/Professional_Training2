	...
	<div class="Left">
		...
		<div class="left1">
			<div>
				...
				<ul>
					<li><a href="${pageContext.request.contextPath }/UserNewNotice/show.do" target="ContentFrame" style="text-decoration:none">最新通知</a></li>
					<li><a href="${pageContext.request.contextPath }/MRApplyInfo/show.do" target="ContentFrame" style="text-decoration:none">我的预定</a></li>
					<li><a href="${pageContext.request.contextPath }/MyMeetings.do" target="ContentFrame" style="text-decoration:none">我的会议</a></li>
				</ul>
			</div>
		</div>
		<c:if test="${UserInfo.UI_ROLES=='1' }">
		<div>
			<div>
				...
				<ul>
					<li><a href="DepartmentShow.Enroll" target="ContentFrame" style="text-decoration:none">部门管理</a></li>
					<li><a href="${pageContext.request.contextPath }/UserEnrollEnter.Enroll" target="ContentFrame" style="text-decoration:none">员工注册</a></li>
		...
		<div>
			<div>
				...
				<ul>
					...
					<li><a href="${pageContext.request.contextPath }/MRApplyInfoMR/showmr.do" target="ContentFrame" style="text-decoration:none">预定会议</a></li>
