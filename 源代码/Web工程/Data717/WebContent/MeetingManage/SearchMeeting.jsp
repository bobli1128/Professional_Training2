        				...
        				success:function(result){
        					...
        					var objs=eval(result);
        					 ...
        					 if(l%5==0){
        						 ...
        						 $(".pages").html(Math.ceil(l/5));
        					 }
        					 $(".pagenum").html(i+1);
        					$(objs).each(function(){
        						var name1="'"+this.mi_NAME+"'";
		...
		<table border="1" class="table">
			<caption class="caption">
		 	  <table width="750px" border=0 cellpadding=0 cellspacing=0>
					<tr border=0>
						...
						<font size="3">共</font><strong><font size="3" class="totle">
						</font></strong><font size="3">条结果，分成</font><strong><font size="3" class="pages"></font></strong><font size="3">页显示，当前第</font><strong><font size="3" class="pagenum"></font>
</strong><font size="3">页</font>
						</td>
			...
			<c:forEach items="${SearchMeet }" var="SMeet">
			 <tr style="height: 25px">     
				...
				<td>
					<fmt:formatDate value="${SMeet.MI_START_TIME }" type="both"/>
				</td>
				<td><fmt:formatDate value="${SMeet.MI_END_TIME }" type="both"/></td>
				<td><fmt:formatDate value="${SMeet.MI_BOOK_TIME }" type="both"/></td>
				<td>${SMeet.UI_NAME }</td>
			 </tr>
			</c:forEach>
		</table>
